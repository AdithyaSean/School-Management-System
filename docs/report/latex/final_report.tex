...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{login-page.png}
    \caption{Login Page}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{admin-user-managment-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{administrator-report-management-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{assessment-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{attendance-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{authentication-flow-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{authentication-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{communication-flow-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{exam-management-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{exam-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{generate-monthly-report-dministrator-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{principal-broadcast-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{sectional-head-staff-management-sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{student-assesment-management-sequence.png}
