...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{sectionalhead-staff-managemnet-page.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{teacher-assesements-page.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{teacher-submission-management-page.png}
